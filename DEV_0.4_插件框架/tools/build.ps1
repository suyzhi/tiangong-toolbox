...
& $csc /nologo /target:library /platform:x64 /optimize+ /debug:full /out:"$bin\TianGongCadSuite.dll" /reference:"$interop" /reference:System.Web.Extensions.dll /reference:System.Data.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:Microsoft.CSharp.dll $sources
