...
class HoleFixSpike2 {
    ...
    [STAThread] static int Main(string[] args){
        OutDir = args.Length>0?Path.GetFullPath(args[0]):Path.Combine(Environment.CurrentDirectory,"artifacts","fix-spike2");
        ...
        try{
            ...
            Case(app,"x1-reg-thread-thru",false,0,false,x1_reg_thread_thru);
            Case(app,"x3-reg-thread-blind-v",true,10,false,x3_reg_thread_blind_v);
            Case(app,"x4-reg-thread-depth",true,12,false,x4_reg_thread_depth);
            Case(app,"x5-regex-thread",false,0,false,x5_regex_thread);
            Case(app,"x6-reg-thread-physical",false,0,true,x1_reg_thread_thru);
            Case(app,"x7-reg-chamfer-thread",false,0,false,x7_reg_chamfer_thread);
        } catch(Exception e){ Console.WriteLine("FATAL "+e.GetType().Name+": "+e.Message); }
        finally{ try{ if(app!=null&&own) app.Quit(); }catch{} }
        Console.WriteLine("FIX-SPIKE2 DONE");
        return 0;
    }

    delegate P.HoleData Maker(P.PartDocument part);
    static void Case(F.Application app,string tag,bool finite,double depthMm,bool physical,Maker make){
    ...
    static void CountCones(G.Body body,out int cones,out string info){
        ...
        foreach(G.Face f in faces){
            ...
            try{ Array o=new double[3],ax=new double[3]; double r=0,ang=0; bool ex=false;
                 ...
                 list.Add("CONE origin_z="+F(D(o,2)*1000)+"mm r="+F(r*1000)+"mm angle="+F(ang*180/Math.PI)+"deg");
            }catch{}
        }
    ...
    static string Brief(P.HoleData d){
        return "type="+Safe(()=>d.HoleType.ToString())+" holeDia="+Safe(()=>F(d.HoleDiameter*1000))+" bottom="+Safe(()=>F(d.BottomAngle))
            ...
            +" thDep="+Safe(()=>F(d.ThreadDepth*1000))+" thDepM="+Safe(()=>d.ThreadDepthMethod.ToString());
    }
    ...
    static P.HoleData x1_reg_thread_thru(P.PartDocument p){
        return p.HoleDataCollection.Add(P.FeaturePropertyConstants.igRegularHole, 0.004917,
    ...
    static P.HoleData x3_reg_thread_blind_v(P.PartDocument p){
        return p.HoleDataCollection.Add(P.FeaturePropertyConstants.igRegularHole, 0.004917,
                    0.0/*1:CounterboreDiameter*/, 0.0/*2:CounterboreDepth*/, 0.0/*3:CountersinkDiameter*/, 0.0/*4:CountersinkAngle*/, 118.0/*5:BottomAngle*/,
                    P.FeaturePropertyConstants.igNone/*6:TreatmentType*/, X/*7:TaperMethod*/, X/*8:Taper*/, 0.004917/*9:ThreadMinorDiameter*/, X/*10:ThreadDepthMethod*/,
    ...
    static P.HoleData x4_reg_thread_depth(P.PartDocument p){
        return p.HoleDataCollection.Add(P.FeaturePropertyConstants.igRegularHole, 0.004917,
                    0.0/*1:CounterboreDiameter*/, 0.0/*2:CounterboreDepth*/, 0.0/*3:CountersinkDiameter*/, 0.0/*4:CountersinkAngle*/, 118.0/*5:BottomAngle*/,
                    P.FeaturePropertyConstants.igNone/*6:TreatmentType*/, X/*7:TaperMethod*/, X/*8:Taper*/, 0.004917/*9:ThreadMinorDiameter*/, P.FeaturePropertyConstants.igFinite/*10:ThreadDepthMethod*/,
                    0.008/*11:ThreadDepth*/, P.FeaturePropertyConstants.igVBottomDimToV/*12:VBottomDimType*/, X/*13:TaperDimType*/, X/*14:CounterboreProfileLocationType*/, X/*15:TaperLValue*/,
                    X/*16:TaperRValue*/, 0.006/*17:ThreadExternalDiameter*/, "M6"/*18:ThreadDescription*/, true/*19:IgnoreSavedDefaultValues*/);
    }
    static P.HoleData x5_regex_thread(P.PartDocument p){
        return p.HoleDataCollection.AddEx(P.FeaturePropertyConstants.igRegularHole,
    ...
    static P.HoleData x7_reg_chamfer_thread(P.PartDocument p){
        P.HoleData d = p.HoleDataCollection.Add(P.FeaturePropertyConstants.igRegularHole, 0.004917,
                    0.0/*1:CounterboreDiameter*/, 0.0/*2:CounterboreDepth*/, 0.0/*3:CountersinkDiameter*/, 0.0/*4:CountersinkAngle*/, 0.0/*5:BottomAngle*/,
                    P.FeaturePropertyConstants.igNone/*6:TreatmentType*/, X/*7:TaperMethod*/, X/*8:Taper*/, 0.004917/*9:ThreadMinorDiameter*/, X/*10:ThreadDepthMethod*/,
                    X/*11:ThreadDepth*/, P.FeaturePropertyConstants.igVBottomDimToFlat/*12:VBottomDimType*/, X/*13:TaperDimType*/, X/*14:CounterboreProfileLocationType*/, X/*15:TaperLValue*/,
                    X/*16:TaperRValue*/, 0.006/*17:ThreadExternalDiameter*/, "M6"/*18:ThreadDescription*/, true/*19:IgnoreSavedDefaultValues*/);;
