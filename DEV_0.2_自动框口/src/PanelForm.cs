...
namespace TianGongPanelAuto {
    public static class Log {
        public static string FilePath {get{return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"TianGongPanelAuto","panel.log");}}
    ...
    public sealed class PanelForm : Form,F.ISEMouseEvents,F.ISECommandEvents {
        ...
        public void StartPicking(){
            try {
                ...
                Log.Write("PickStart","build=0.2.0, CAD="+app.Version+", interDocument="+InterDocumentPicking+", locateMode="+mouse.LocateMode+", move="+mouse.EnabledMove+", windowTypes="+mouse.WindowTypes);
