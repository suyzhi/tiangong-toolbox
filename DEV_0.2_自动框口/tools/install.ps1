...
$key.SetValue('409','Rectangle Panel (DEV 0.2.0)')
$key.SetValue('804',[string]([char]0x77E9)+[char]0x5F62+[char]0x677F+' (DEV 0.2.0)')
...
Write-Output 'Use the TianGong CAD add-in manager to enable Rectangle Panel (DEV 0.2.0), or restart CAD.'
