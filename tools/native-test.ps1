param([string]$OutputPath,[switch]$NewInstance)
...
$addin=$null
foreach($a in $app.AddIns){if($a.GUID -eq '{98BF0FA8-7D65-4A13-9926-6A45836FD6D2}'){$addin=$a;break}}
...
$addin.Object.StartTests([IO.Path]::GetFullPath($OutputPath))
