    ...
    public sealed class PanelForm : Form,F.ISEMouseEvents,F.ISECommandEvents {
        ...
        public void StartPicking(){
            try {
                ...
                Log.Write("PickStart","build=0.3.0, CAD="+app.Version+", interDocument="+InterDocumentPicking+", locateMode="+mouse.LocateMode+", move="+mouse.EnabledMove+", windowTypes="+mouse.WindowTypes);
